...
```{r 6 means}
# find the mean of period-specific treatment effects from question 5
# only looking at the periods after treatment
# tidy(model5) %>% 
#   [c("trt_period::0:TLyes":"trt_period::18:TLyes")]
# 
# 
# 
# 
# comp_data <- data.frame(
#   model = c("model 3", "model 5"),
#   modmean = c((mean(model5$coefficients)), (mean(model3b$coefficients))),
#   modse = c()
#     
#     
#   )
